# Comparison of CHC amount and proportions in between different categories of individuals
...
## Difference in the proportion of CHCs characteristic of *F. sanguinea* between mature *F. sanguinea* and *F. fusca*
```{r}
...
## Difference in the proportion of CHCs characteristic of *F. sanguinea* between mature and callow *F. sanguinea* 
```{r}
test_data <- filter(development_samples, species == "F. sanguinea")
test_data$sang_prop <- subsample_proportion(peaks_sang, test_data$chromatogram_ID)
