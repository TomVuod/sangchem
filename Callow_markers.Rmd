...
predicted_species <- matrix(predicted_species$predicted_species[match(predicted_species$chromatogram_ID), rownames(peak_prop)], ncol=1, dimnames = list(rownames(peak_prop), "predicted_species"))
library(Hmisc) 
