...
## Species markers
This chapter shows the way how the peaks associated with *F. sanguinea* and *F. fusca* (species markers) were determined. We use the chemical data collected from the filed colonies in the earlier study [@WLODARCZYK201798] to train the discrimination model.
...
peaks_sang <- res$chromatogram_ID[res$predicted_species>=quantile(res$predicted_species, 0.8)]
``` 
