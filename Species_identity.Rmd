...
```{r}
peaks_fusca <- as.numeric(gsub("peak_", "", names(peak_coefficients)[peak_coefficients<(-10^-3)]))
peaks_sang <- as.numeric(gsub("peak_", "", names(peak_coefficients)[peak_coefficients>(10^-3)]))
``` 
