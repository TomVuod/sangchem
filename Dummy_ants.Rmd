...
In control treatment glass beads were not covered by CHCs. In experimantal treamtent CHCs from donor colonies were contaminated with docosane which served as internal standard. We look for the differences in the proportion on docosane in the CHC profile of tested ants to judge about chemicals acqusition from dummy ants.
...
## Difference in the proportion of CHCs characteristic of callow *F. sanguinea* between mature and callow *F. sanguinea* 
```{r}
test_data <- filter(development_samples, species == "F. sanguinea")
...
## Difference in the amount of CHCs characteristic of callow *F. sanguinea* between mature and callow *F. sanguinea* 
```{r}
test_data <- filter(development_samples, species == "F. sanguinea")
...
## Difference in the proportion of CHCs characteristic of *F. fusca* between mature *F. sanguinea* and *F. fusca*
```{r}
...
## Difference in the proportion of CHCs characteristic of *F. fusca* between mature and callow *F. sanguinea* 
```{r}
test_data <- filter(development_samples, species == "F. sanguinea")
test_data$fusca_prop <- subsample_proportion(peaks_fusca, test_data$chromatogram_ID)
test_data_mature <- filter(test_data, callow ==  0) %>% 
...
## Difference in the proportion of CHCs characteristic of *F. fusca* between callow *F. sanguinea* and *F. fusca*
```{r}
