...
```{r warning=FALSE, fig.cap="Ratios of the planar projection areas of three body parts (head, thorax dorsal view, thorax lateral view) to the square of head width."}
library(sangchem)
library(ggplot2)
data("development_data")
data("separation_experiment_data")
