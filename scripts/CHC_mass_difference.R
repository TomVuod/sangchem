...
pred_values_sang <- unlist(bplapply(1:1000, predict_values, model = lm_model, sang_prop = 1, seeds = seeds, BPPARAM = MulticoreParam(RNG=4381)))
...
saveRDS(list(pred_values_sang=res_sang, pred_values_fusca=res_fusca), "/home/t.wlodarczyk/chemical_ecology/sangchem/output/predicted_values.rds")
