...
AUC_basic <- c()
for(i in 1:10) AUC_basic <- c(AUC_basic, readRDS(paste0("true_labels_3_groups_", i, ".rds"))$AUC[1:100])

AUC_random <- c()
for(i in 1:10) AUC_random <- c(AUC_random, readRDS(paste0("random_labels_3_groups_", i, ".rds"))$AUC[1:100])
