...
peaks_fusca <- as.numeric(rownames(orig_var_effects)[orig_var_effects[,2]<=quantile(orig_var_effects[,2], 0.1)])
peaks_sang <- as.numeric(rownames(orig_var_effects)[orig_var_effects[,2]>=quantile(orig_var_effects[,2], 0.9)])
