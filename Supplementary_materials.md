...
##    Data: model_input
## 
## REML criterion at convergence: 1719.9
## 
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
...
## Random effects:
##  Groups   Name        Variance  Std.Dev.
##  colony   (Intercept) 3.155e+09 56170   
##  Residual             9.110e+09 95447   
## Number of obs: 68, groups:  colony, 16
## 
## Fixed effects:
##              Estimate Std. Error        df t value Pr(>|t|)    
## (Intercept) 1.218e+06  2.641e+04 3.893e+01  46.121  < 2e-16 ***
## sang_prop   1.251e+05  4.344e+04 6.210e+01   2.881  0.00544 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
##    Data: model_input
## 
## REML criterion at convergence: 148.1
## 
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
...
## I(head_width^2) -2.012e-13  2.134e-13  6.167e+01  -0.943 0.349440    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## I(head_width^2) -8.355e-13  3.270e-13  5.972e+01  -2.555 0.013192 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## I(head_width^2) -1.603e-13  1.006e-13  6.993e+01  -1.594    0.116    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
## Random effects:
##  Groups             Name        Variance Std.Dev.
##  colony:census_date (Intercept) 0.000    0.0000  
##  colony             (Intercept) 0.259    0.5089  
##  Residual                       0.383    0.6188  
## Number of obs: 78, groups:  colony:census_date, 55; colony, 20
## 
## Fixed effects:
##                   Estimate Std. Error         df t value Pr(>|t|)    
## (Intercept)      1.911e-03  6.383e-01  7.162e+01   0.003   0.9976    
## sang_prop       -1.367e+00  2.715e-01  6.631e+01  -5.034 3.93e-06 ***
## I(head_width^2) -9.525e-13  5.398e-13  7.330e+01  -1.765   0.0818 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
